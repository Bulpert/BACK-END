<?php
	...
	if(!$mensagem->mensagemValida()) {
		...
		// O método die() é utilizado para finalizar a operação caso ele seja chamado
		//die();
	...
	try {
			...
			// Aqui você incluirá seu e-mail (remetente)
			...
			//Recipients
			$mail->setFrom('bulplog@gmail.com', 'Bulp log debugger');
		...
		<div class="row">
			...
			<? if($mensagem->status['codigo_status'] == 1) { ?>
					...
					<div class="container">
						...
						<a href="index.php" class="btn btn-success bnt-lg mt-5 text-white">Voltar</a>
					</div>
